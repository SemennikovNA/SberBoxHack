Ваш `README.md` файл содержит несколько ошибок форматирования Markdown, которые могут привести к неправильному отображению на GitHub. Вот исправленный вариант вашего файла:
